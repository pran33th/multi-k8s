...
kubectl set image deployments/client-deployment server=pr2n33th/multi-client:$SHA
kubectl set image deployments/worker-deployment server=pr2n33th/multi-worker:$SHA
